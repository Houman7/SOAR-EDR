# SOAR-EDR
This SOAR-EDR integration project leverages Tines for security orchestration and LimaCharlie for endpoint detection to create an automated incident response pipeline that rapidly identifies and contains threats.
